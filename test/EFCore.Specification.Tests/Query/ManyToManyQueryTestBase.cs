    ...
    where TFixture : ManyToManyQueryFixtureBase, new()
{
    ...
    public virtual Task Skip_navigation_all(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().Where(e => e.TwoSkip.All(e => e.Name.Contains("B"))));
    ...
    public virtual Task Skip_navigation_any_without_predicate(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().Where(e => e.ThreeSkipPayloadFull.Where(e => e.Name.Contains("B")).Any()),
            assertEmpty: true);
    ...
    public virtual Task Skip_navigation_any_with_predicate(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().Where(e => e.TwoSkipShared.Any(e => e.Name.Contains("B"))),
            assertEmpty: true);
    ...
    public virtual Task Skip_navigation_contains(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().Where(e => e.ThreeSkipPayloadFullShared.Contains(new EntityThree<int> { Id = 1 })),
            ss => ss.Set<EntityOne<int>>().Where(e => e.ThreeSkipPayloadFullShared.Select(i => i.Id).Contains(1)));
    ...
    public virtual Task Skip_navigation_count_without_predicate(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().Where(e => e.SelfSkipPayloadLeft.Count > 0));
    ...
    public virtual Task Skip_navigation_count_with_predicate(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().OrderBy(e => e.BranchSkip.Count(e => e.Name.StartsWith("L")))
                .ThenBy(e => e.Id),
            assertOrder: true);
    ...
    public virtual Task Skip_navigation_long_count_without_predicate(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityTwo<int>>().Where(e => e.ThreeSkipFull.LongCount() > 0));
    ...
    public virtual Task Skip_navigation_long_count_with_predicate(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityTwo<int>>().OrderByDescending(e => e.SelfSkipSharedLeft.LongCount(e => e.Name.StartsWith("L")))
                .ThenBy(e => e.Id),
            assertOrder: true);
    ...
    public virtual Task Skip_navigation_select_many_average(bool async)
        => AssertAverage(
            async,
            ss => ss.Set<EntityTwo<int>>().SelectMany(e => e.CompositeKeySkipShared.Select(e => e.Key1)));
    ...
    public virtual Task Skip_navigation_select_many_max(bool async)
        => AssertMax(
            async,
            ss => ss.Set<EntityThree<int>>().SelectMany(e => e.CompositeKeySkipFull.Select(e => e.Key1)));
    ...
    public virtual Task Skip_navigation_select_many_min(bool async)
        => AssertMin(
            async,
            ss => ss.Set<EntityThree<int>>().SelectMany(e => e.RootSkipShared.Select(e => e.Id)));
    ...
    public virtual Task Skip_navigation_select_many_sum(bool async)
        => AssertSum(
            async,
            ss => ss.Set<EntityRoot<int>>().SelectMany(e => e.CompositeKeySkipShared.Select(e => e.Key1)));
    ...
    public virtual Task Skip_navigation_select_subquery_average(bool async)
        => AssertQueryScalar(
            async,
            ss => ss.Set<EntityLeaf<int>>().Select(e => e.CompositeKeySkipFull.Average(e => e.Key1)));
    ...
    public virtual Task Skip_navigation_select_subquery_max(bool async)
        => AssertQueryScalar(
            async,
            ss => ss.Set<EntityTwo<int>>().Select(e => e.OneSkip.Max(e => e.Id)));
    ...
    public virtual Task Skip_navigation_select_subquery_min(bool async)
        => AssertQueryScalar(
            async,
            ss => ss.Set<EntityThree<int>>().Select(e => e.OneSkipPayloadFull.Min(e => e.Id)));
    ...
    public virtual Task Skip_navigation_select_subquery_sum(bool async)
        => AssertQueryScalar(
            async,
            ss => ss.Set<EntityTwo<int>>().Select(e => e.OneSkipShared.Sum(e => e.Id)));
    ...
    public virtual Task Skip_navigation_order_by_first_or_default(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityThree<int>>().Select(e => e.OneSkipPayloadFullShared.OrderBy(i => i.Id).FirstOrDefault()));
    ...
    public virtual Task Skip_navigation_order_by_single_or_default(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().Select(e => e.SelfSkipPayloadRight.OrderBy(i => i.Id).Take(1).SingleOrDefault()));
    ...
    public virtual Task Skip_navigation_order_by_last_or_default(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityBranch<int>>().Select(e => e.OneSkip.OrderBy(i => i.Id).LastOrDefault()));
    ...
    public virtual Task Skip_navigation_order_by_reverse_first_or_default(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityThree<int>>().Select(e => e.TwoSkipFull.OrderBy(i => i.Id).Reverse().FirstOrDefault()));
    ...
    public virtual Task Skip_navigation_cast(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityCompositeKey<int>>().OrderBy(e => e.Key1).Select(e => e.LeafSkipFull.Cast<EntityRoot<int>>()),
            assertOrder: true,
    ...
    public virtual Task Skip_navigation_of_type(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityCompositeKey<int>>().OrderBy(e => e.Key1).Select(e => e.RootSkipShared.OfType<EntityLeaf<int>>()),
            assertOrder: true,
            elementAsserter: (e, a) => AssertCollection(e, a));
    ...
    public virtual Task Join_with_skip_navigation(bool async)
        => AssertQuery(
            async,
            ss => from t in ss.Set<EntityTwo<int>>()
                  join s in ss.Set<EntityTwo<int>>()
    ...
    public virtual Task Left_join_with_skip_navigation(bool async)
        => AssertQuery(
            async,
            ss => from t in ss.Set<EntityCompositeKey<int>>()
                  join s in ss.Set<EntityCompositeKey<int>>()
    ...
    public virtual Task Select_many_over_skip_navigation(bool async)
        => AssertQuery(
            async,
            ss => from r in ss.Set<EntityRoot<int>>()
    ...
    public virtual Task Select_many_over_skip_navigation_where(bool async)
        => AssertQuery(
            async,
            ss => from r in ss.Set<EntityOne<int>>()
    ...
    public virtual Task Select_many_over_skip_navigation_of_type(bool async)
        => AssertQuery(
            async,
            ss => from r in ss.Set<EntityThree<int>>()
                  from t in r.RootSkipShared.OfType<EntityBranch<int>>()
                  select t);
    ...
    public virtual Task Select_many_over_skip_navigation_cast(bool async)
        => AssertQuery(
            async,
            ss => from r in ss.Set<EntityOne<int>>()
                  from t in r.BranchSkip.Cast<EntityRoot<int>>()
                  select t);
    ...
    public virtual Task Select_skip_navigation_multiple(bool async)
        => AssertQuery(
            async,
            ss => from r in ss.Set<EntityTwo<int>>()
                  orderby r.Id
                  select new
                  {
                      r.ThreeSkipFull,
    ...
    public virtual Task Include_skip_navigation(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityCompositeKey<int>>().Include(e => e.RootSkipShared),
    ...
    public virtual Task Include_skip_navigation_then_reference(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityTwo<int>>().Include(e => e.OneSkip).ThenInclude(e => e.Reference),
    ...
    public virtual Task Include_skip_navigation_then_include_skip_navigation(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityCompositeKey<int>>().Include(e => e.LeafSkipFull).ThenInclude(e => e.OneSkip),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
    ...
    public virtual Task Include_skip_navigation_and_reference(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityTwo<int>>().Include(e => e.OneSkipShared).Include(e => e.Reference),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
    ...
    public virtual Task Include_skip_navigation_then_include_inverse_works_for_tracking_query(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityThree<int>>().Include(e => e.OneSkipPayloadFullShared).ThenInclude(e => e.ThreeSkipPayloadFullShared),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
                new ExpectedInclude<EntityThree<int>>(et => et.OneSkipPayloadFullShared),
                new ExpectedInclude<EntityOne<int>>(et => et.ThreeSkipPayloadFullShared, "OneSkipPayloadFullShared")));
    ...
    public virtual Task Filtered_include_skip_navigation_where(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityThree<int>>().Include(e => e.OneSkipPayloadFullShared.Where(i => i.Id < 10)),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
    ...
    public virtual Task Filtered_include_skip_navigation_order_by(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityThree<int>>().Include(e => e.TwoSkipFull.OrderBy(i => i.Id)),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
    ...
    public virtual Task Filtered_include_skip_navigation_order_by_skip(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityTwo<int>>().Include(e => e.SelfSkipSharedRight.OrderBy(i => i.Id).Skip(2)),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
    ...
    public virtual Task Filtered_include_skip_navigation_order_by_take(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityCompositeKey<int>>().Include(e => e.TwoSkipShared.OrderBy(i => i.Id).Take(2)),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
    ...
    public virtual Task Filtered_include_skip_navigation_order_by_take_EF_Property(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityCompositeKey<int>>().Include(
                e => EF.Property<ICollection<EntityTwo<int>>>(e, "TwoSkipShared").OrderBy(i => i.Id).Take(2)),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
                new ExpectedFilteredInclude<EntityCompositeKey<int>, EntityTwo<int>>(
                    et => et.TwoSkipShared, includeFilter: x => x.OrderBy(i => i.Id).Take(2))));
    ...
    public virtual Task Filtered_include_skip_navigation_order_by_skip_take(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityCompositeKey<int>>().Include(e => e.ThreeSkipFull.OrderBy(i => i.Id).Skip(1).Take(2)),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
    ...
    public virtual Task Filtered_include_skip_navigation_where_then_include_skip_navigation(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityLeaf<int>>().Include(e => e.CompositeKeySkipFull.Where(i => i.Key1 < 5)).ThenInclude(e => e.TwoSkipShared),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
    ...
    public virtual Task Filtered_include_skip_navigation_order_by_skip_take_then_include_skip_navigation_where_EF_Property(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().Include(e => EF.Property<ICollection<EntityTwo<int>>>(e, "TwoSkip").OrderBy(i => i.Id).Skip(1).Take(2))
                .ThenInclude<EntityOne<int>, EntityTwo<int>, IEnumerable<EntityThree<int>>>(
                    e => EF.Property<ICollection<EntityThree<int>>>(e, "ThreeSkipFull").Where(i => i.Id < 10)),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
                new ExpectedFilteredInclude<EntityOne<int>, EntityTwo<int>>(
                    et => et.TwoSkip, includeFilter: x => x.OrderBy(i => i.Id).Skip(1).Take(2)),
    ...
    public virtual Task Filter_include_on_skip_navigation_combined_with_filtered_then_includes(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityThree<int>>().Include(e => e.OneSkipPayloadFull.Where(i => i.Id < 10))
    ...
    public virtual async Task Throws_when_different_filtered_include(bool async)
        => Assert.Equal(
            ...
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => AssertQuery(
                    async,
                    ss => ss.Set<EntityTwo<int>>().Include(e => e.OneSkip.Where(i => i.Id < 10)).ThenInclude(e => e.BranchSkip)
    ...
    public virtual async Task Throws_when_different_filtered_then_include(bool async)
        => Assert.Equal(
            ...
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => AssertQuery(
                    async,
                    ss => ss.Set<EntityCompositeKey<int>>()
    ...
    public virtual Task Includes_accessed_via_different_path_are_merged(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().Include(e => e.ThreeSkipPayloadFull).ThenInclude(e => e.CollectionInverse)
                .Include(e => e.JoinThreePayloadFull).ThenInclude(e => e.Three).ThenInclude(e => e.ReferenceInverse),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
                new ExpectedInclude<EntityOne<int>>(e => e.ThreeSkipPayloadFull),
                new ExpectedInclude<EntityThree<int>>(e => e.CollectionInverse, "ThreeSkipPayloadFull"),
                new ExpectedInclude<EntityOne<int>>(e => e.JoinThreePayloadFull),
                new ExpectedInclude<JoinOneToThreePayloadFull<int>>(e => e.Three, "JoinThreePayloadFull"),
                new ExpectedInclude<EntityThree<int>>(e => e.ReferenceInverse, "JoinThreePayloadFull.Three"),
                new ExpectedInclude<EntityThree<int>>(e => e.ReferenceInverse, "ThreeSkipPayloadFull"),
                new ExpectedInclude<EntityThree<int>>(e => e.CollectionInverse, "JoinThreePayloadFull.Three")));
    ...
    public virtual Task Filtered_includes_accessed_via_different_path_are_merged(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityThree<int>>().Include(e => e.OneSkipPayloadFull).ThenInclude(e => e.Collection.Where(i => i.Id < 5))
                .Include(e => e.JoinOnePayloadFull).ThenInclude(e => e.One).ThenInclude(e => e.Collection)
                .ThenInclude(e => e.Reference),
            elementAsserter: (e, a) => AssertInclude(
                e, a,
                new ExpectedInclude<EntityThree<int>>(e => e.OneSkipPayloadFull),
                new ExpectedFilteredInclude<EntityOne<int>, EntityTwo<int>>(
                    e => e.Collection, "OneSkipPayloadFull", includeFilter: x => x.Where(i => i.Id < 5)),
                new ExpectedInclude<EntityThree<int>>(e => e.JoinOnePayloadFull),
                new ExpectedInclude<JoinOneToThreePayloadFull<int>>(e => e.One, "JoinOnePayloadFull"),
                new ExpectedFilteredInclude<EntityOne<int>, EntityTwo<int>>(
                    e => e.Collection, "JoinOnePayloadFull.One", includeFilter: x => x.Where(i => i.Id < 5)),
                new ExpectedInclude<EntityTwo<int>>(e => e.Reference, "OneSkipPayloadFull.Collection"),
                new ExpectedInclude<EntityTwo<int>>(e => e.Reference, "JoinOnePayloadFull.One.Collection")));
    ...
    {
        var two = new EntityTwo<int> { Id = 1 };

        return AssertQuery(
            async,
            ss => ss.Set<EntityOne<int>>().Where(e => e.TwoSkip.Contains(two)),
            ss => ss.Set<EntityOne<int>>().Where(e => e.TwoSkip.Select(i => i.Id).Contains(two.Id)));
    }
    ...
    public virtual Task GetType_in_hierarchy_in_base_type(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityRoot<int>>().Where(e => e.GetType() == typeof(EntityRoot<int>)));
    ...
    public virtual Task GetType_in_hierarchy_in_intermediate_type(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityRoot<int>>().Where(e => e.GetType() == typeof(EntityBranch<int>)));
    ...
    public virtual Task GetType_in_hierarchy_in_leaf_type(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityRoot<int>>().Where(e => e.GetType() == typeof(EntityLeaf<int>)));
    ...
    public virtual Task GetType_in_hierarchy_in_querying_base_type(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<EntityBranch<int>>().Where(e => e.GetType() == typeof(EntityRoot<int>)),
            assertEmpty: true);
