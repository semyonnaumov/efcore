...
public class LiftableConstantExpressionHelpers
{
    ...
    public static bool IsLiteral(object? value)
    {
        ...
        if (value != null && value.GetType().Name == "SelectExpression")
        {
            return true;
        }
        ...
        return value switch
        {
            ...
            null or Type or Enum or CultureInfo or Encoding or IPAddress or ValueBuffer /*VB is temporary for InMemory */=> true,
