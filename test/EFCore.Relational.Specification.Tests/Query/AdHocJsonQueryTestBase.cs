...
public abstract class AdHocJsonQueryTestBase : NonSharedModelTestBase
{
    ...
    protected virtual async Task Seed32310(Context32310 context)
    {
    ...
    protected abstract Task Seed29219(Context29219 ctx);
    ...
    protected abstract Task Seed30028(Context30028 ctx);
    ...
    protected Task Seed30028(Context32939 ctx)
    {
        ...
        {
            Empty = new Context32939.JsonEmpty(), FieldOnly = new Context32939.JsonFieldOnly()
        };
...
#pragma warning restore IDE0044 // Add readonly modifier
    ...
    protected abstract Task SeedArrayOfPrimitives(ContextArrayOfPrimitives ctx);
    ...
    protected abstract Task SeedTrickyBuffering(ContextTrickyBuffering ctx);
    ...
    protected abstract Task SeedShadowProperties(ContextShadowProperties ctx);
    ...
    private Task SeedLazyLoadingProxies(ContextLazyLoadingProxies ctx)
    {
    ...
    protected abstract Task SeedNotICollection(ContextNotICollection ctx);
