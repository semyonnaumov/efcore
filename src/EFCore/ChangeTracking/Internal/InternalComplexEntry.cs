...
public sealed class InternalComplexEntry : InternalEntryBase
{
    ...
    {
        Check.DebugAssert(property.DeclaringType.ContainingType == ComplexType, "Property " + property.Name + " not contained under " + ComplexType.Name);
    ...
    public string GetPropertyPath()
    {
        ...
        result += GetShortNameChain(ComplexType.ComplexProperty.DeclaringType) + ComplexProperty.Name + '[' + Ordinal + ']';
