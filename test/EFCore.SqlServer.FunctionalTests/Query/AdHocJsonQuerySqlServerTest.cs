...
public class AdHocJsonQuerySqlServerTest : AdHocJsonQueryTestBase
{
    ...
    protected override async Task Seed29219(Context29219 ctx)
    {
...
""");
    ...
    protected override async Task Seed30028(Context30028 ctx)
    {
        // complete
        await ctx.Database.ExecuteSqlAsync(
            $$$$"""
...
""");
    ...
    protected override Task SeedArrayOfPrimitives(ContextArrayOfPrimitives ctx)
    {
    ...
    protected override Task SeedJunkInJson(ContextJunkInJson ctx)
        => ctx.Database.ExecuteSqlAsync(
            $$$$"""
...
""");
    ...
    protected override Task SeedTrickyBuffering(ContextTrickyBuffering ctx)
        => ctx.Database.ExecuteSqlAsync(
            $$$"""
...
""");
    ...
    protected override Task SeedShadowProperties(ContextShadowProperties ctx)
        => ctx.Database.ExecuteSqlAsync(
            $$"""
...
""");
    ...
    protected override async Task SeedNotICollection(ContextNotICollection ctx)
    {
        await ctx.Database.ExecuteSqlAsync(
            $$"""
...
""");
    ...
    private Task SeedEnumLegacyValues(ContextEnumLegacyValues ctx)
        => ctx.Database.ExecuteSqlAsync(
            $$"""
