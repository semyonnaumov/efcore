...
public abstract class ShapedQueryCompilingExpressionVisitor : ExpressionVisitor
{
    ...
    private sealed class EntityMaterializerInjectingExpressionVisitor : ExpressionVisitor
    {
        ...
        private readonly EntityConstantExpressionRewriter _entityConstantExpressionRewriter;
            ...
            QueryTrackingBehavior queryTrackingBehavior)
        {
            ...
            _entityConstantExpressionRewriter = new(liftableConstantFactory);
        }
        ...
        private sealed class EntityConstantExpressionRewriter(ILiftableConstantFactory liftableConstantFactory) : ExpressionVisitor
        {
            protected override Expression VisitConstant(ConstantExpression constantExpression)
            {
                if (constantExpression is { Value: IEntityType entityTypeValue })
                {
            ...
            ParameterExpression? entryVariable)
        {
            ...
            materializationConditionBody = _entityConstantExpressionRewriter.Visit(materializationConditionBody);
