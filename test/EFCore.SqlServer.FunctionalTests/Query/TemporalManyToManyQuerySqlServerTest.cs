...
public class TemporalManyToManyQuerySqlServerTest : ManyToManyQueryRelationalTestBase<TemporalManyToManyQuerySqlServerFixture>
{
    ...
    protected override Expression RewriteServerQueryExpression(Expression serverQueryExpression)
    {
        ...
        {
            typeof(EntityOne<int>),
            typeof(EntityTwo<int>),
            typeof(EntityThree<int>),
            typeof(EntityCompositeKey<int>),
            typeof(EntityRoot<int>),
            typeof(EntityBranch<int>),
            typeof(EntityLeaf<int>),
            typeof(EntityBranch2<int>),
            typeof(EntityLeaf2<int>),
